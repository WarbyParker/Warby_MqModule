...
class PhpAmqpLib_Connection_AMQPLazyConnection extends PhpAmqpLib_Connection_AMQPConnection
{
    protected $sock = null;
    ...
    /**
     * @return null|\PhpAmqpLib\Wire\IO\PhpAmqpLib_Wire_IO_AbstractIO
     */
