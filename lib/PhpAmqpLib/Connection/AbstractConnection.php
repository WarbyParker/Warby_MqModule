...
class PhpAmqpLib_Connection_AbstractConnection extends PhpAmqpLib_Channel_AbstractChannel
{
    ...
    /**
     * @var null|\PhpAmqpLib\Wire\IO\PhpAmqpLib_Wire_IO_AbstractIO
     */
    protected $io = null;
    ...
    public function get_free_channel_id()
    {
        ...
        throw new PhpAmqpLib_Exception_AMQPRuntimeException("No free channel ids");
    }
    ...
    public function channel($channel_id = null)
    {
        if (isset($this->channels[$channel_id])) {
            ...
            $ch = new PhpAmqpLib_Channel_AMQPChannel($this->connection, $channel_id);
    ...
    protected function connection_close($args)
    {
        ...
        throw new PhpAmqpLib_Exception_AMQPProtocolConnectionException($reply_code, $reply_text, array($class_id, $method_id));
    }
    ...
    /**
     * @return \PhpAmqpLib\Wire\IO\PhpAmqpLib_Wire_IO_AbstractIO
     */
