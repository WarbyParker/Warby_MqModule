...
class PhpAmqpLib_Channel_AMQPChannel extends PhpAmqpLib_Channel_AbstractChannel
{
    ...
    protected function channel_close($args)
    {
        ...
        throw new PhpAmqpLib_Exception_AMQPProtocolChannelException($reply_code, $reply_text,
